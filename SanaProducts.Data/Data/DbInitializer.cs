...
namespace SanaProducts.Data.Data
{
    public static class DbInitializer
    {
        public static void Initialize(SanaProductsDbContext context)
        {
           ...
           {
               new Order{CustomerId=1, OrderDate=Convert.ToDateTime("13/12/2021"),ShippedDate=Convert.ToDateTime("16/12/2021"),Country="COLOMBIA",State="BOGOTÁ",City="BOGOTÁ",FullAddress="Carrera 22 No. 17-31",AddressType=AddressType.Home,PostalCode="110111",AdditionalInformation=""},
               new Order{CustomerId=2, OrderDate=Convert.ToDateTime("13/12/2021"),ShippedDate=Convert.ToDateTime("16/12/2021"),Country="COLOMBIA",State="BOGOTÁ",City="BOGOTÁ",FullAddress="Calle 59 No. 27 - 35 Barrio Galán",AddressType=AddressType.Home,PostalCode="110111",AdditionalInformation=""},
               new Order{CustomerId=3, OrderDate=Convert.ToDateTime("13/12/2021"),ShippedDate=Convert.ToDateTime("16/12/2021"),Country="COLOMBIA",State="BOGOTÁ",City="BOGOTÁ",FullAddress="Calle 12 No. 4 - 19  Edificio Panamericano Of. 406",AddressType=AddressType.Home,PostalCode="110111",AdditionalInformation=""},
               new Order{CustomerId=4, OrderDate=Convert.ToDateTime("13/12/2021"),ShippedDate=Convert.ToDateTime("16/12/2021"),Country="COLOMBIA",State="BOGOTÁ",City="BOGOTÁ",FullAddress="Calle 33B  No. 38 - 42  Barrio Barzal",AddressType=AddressType.Home,PostalCode="110111",AdditionalInformation=""},
               new Order{CustomerId=5, OrderDate=Convert.ToDateTime("13/12/2021"),ShippedDate=Convert.ToDateTime("16/12/2021"),Country="COLOMBIA",State="ANTIOQUIA",City="MEDELLÍN",FullAddress="Calle 15 No. 9 - 56 centro",AddressType=AddressType.Home,PostalCode="50001",AdditionalInformation=""},
               new Order{CustomerId=6, OrderDate=Convert.ToDateTime("13/12/2021"),ShippedDate=Convert.ToDateTime("16/12/2021"),Country="COLOMBIA",State="ANTIOQUIA",City="MEDELLÍN",FullAddress="CARRERA 42 No.5C-48 Barrio Tequendama",AddressType=AddressType.Home,PostalCode="50001",AdditionalInformation=""},
               new Order{CustomerId=7, OrderDate=Convert.ToDateTime("13/12/2021"),ShippedDate=Convert.ToDateTime("16/12/2021"),Country="COLOMBIA",State="ANTIOQUIA",City="MEDELLÍN",FullAddress="CALLE 23 No. 12-11",AddressType=AddressType.Home,PostalCode="50001",AdditionalInformation=""},
               new Order{CustomerId=8, OrderDate=Convert.ToDateTime("13/12/2021"),ShippedDate=Convert.ToDateTime("16/12/2021"),Country="COLOMBIA",State="VALLE DEL CAUCA",City="CALI",FullAddress="Carrera 23  No. 10A - 10",AddressType=AddressType.Home,PostalCode="760001",AdditionalInformation=""},
               new Order{CustomerId=9, OrderDate=Convert.ToDateTime("13/12/2021"),ShippedDate=Convert.ToDateTime("16/12/2021"),Country="COLOMBIA",State="VALLE DEL CAUCA",City="CALI",FullAddress="Avda Francisco Newball No. 4A-20 - Edif. Cámara de Comercio Of. 304",AddressType=AddressType.Home,PostalCode="760001",AdditionalInformation=""},
               new Order{CustomerId=10, OrderDate=Convert.ToDateTime("13/12/2021"),ShippedDate=Convert.ToDateTime("16/12/2021"),Country="COLOMBIA",State="VALLE DEL CAUCA",City="CALI",FullAddress="Carrera 3  con Calle 28 Esquina Barrio Claret",AddressType=AddressType.Home,PostalCode="760001",AdditionalInformation=""},
               new Order{CustomerId=1, OrderDate=Convert.ToDateTime("13/12/2021"),ShippedDate=Convert.ToDateTime("16/12/2021"),Country="COLOMBIA",State="BOGOTÁ",City="BOGOTÁ",FullAddress="Carrera 22 No. 17-31",AddressType=AddressType.Home,PostalCode="110111",AdditionalInformation=""},
               new Order{CustomerId=2, OrderDate=Convert.ToDateTime("13/12/2021"),ShippedDate=Convert.ToDateTime("16/12/2021"),Country="COLOMBIA",State="BOGOTÁ",City="BOGOTÁ",FullAddress="Calle 59 No. 27 - 35 Barrio Galán",AddressType=AddressType.Home,PostalCode="110111",AdditionalInformation=""},
               new Order{CustomerId=3, OrderDate=Convert.ToDateTime("13/12/2021"),ShippedDate=Convert.ToDateTime("16/12/2021"),Country="COLOMBIA",State="BOGOTÁ",City="BOGOTÁ",FullAddress="Calle 12 No. 4 - 19  Edificio Panamericano Of. 406",AddressType=AddressType.Home,PostalCode="110111",AdditionalInformation=""},
               new Order{CustomerId=4, OrderDate=Convert.ToDateTime("13/12/2021"),ShippedDate=Convert.ToDateTime("16/12/2021"),Country="COLOMBIA",State="BOGOTÁ",City="BOGOTÁ",FullAddress="Calle 33B  No. 38 - 42  Barrio Barzal",AddressType=AddressType.Home,PostalCode="110111",AdditionalInformation=""},
